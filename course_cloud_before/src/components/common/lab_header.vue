          ...
          >
            <div role="tabpanel" class="tab-pane active" id="signin-form">
              <form action="/login" method="post">
                ...
                <!-- </div> -->
                <!-- <img src="http://192.168.1.19:5000/img/code?uuid=123456" id="img"> -->
                <!-- </div> -->
                ...
                <div class="form-group widget-signin">
                  <img :src="sinaimg" style="cursor: pointer" @click="sina" />
                  <img
                    :src="dingimg"
            ...
            <div role="tabpanel" class="tab-pane" id="signup-form">
              <form action="/register" method="post">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input
                        ...
                        placeholder="请输入验证码"
                      />
                      <!-- <span v-if="count-down === 0" class="time1" @click="sendcode">点击重新发送</span>
                      <span class="time" v-else>{{count-down}}s 重发</span> -->
                ...
                <div class="form-group agree-privacy">
                  注册表示您已经同意我们的<a href="/privacy" target="_blank"
                    >隐私条款</a
                  >
                </div>
...
export default {
  ...
  methods: {
    ...
    sina: function () {
      // 组装url
      let url =
        "https://api.weibo.com/oauth2/authorize?client_id=156528899&redirect_uri=" +
        config["baseurl"] +
        "weibo/";
      // 进行跳转
      window.location.href = url;
    ...
    // 注册
    change_regist() {
      (this.opened = true), (this.login_or_regist = "注册");
    },
    ...
    username_id() {
      ...
      if (this.username == "") {
        ...
        //检测字符串是否符合正则表达式 4到14位（字母，数字，下划线，减号）
    ...
    // 登录
    change_login() {
      (this.opened = true), (this.login_or_regist = "登录");
    },
